...
export default function RegisterPage() {
  ...
  useEffect(() => {
    const fetchSchools = async () => {
      try {
        ...
        // Add default school as fallback
        setSchools([{
          id: '1',
          name: 'White Oaks Secondary School',
          domain: 'hdsb.ca',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // We're not validating email domain against school domain anymore
    // This allows for schoolboard emails like @hdsb.ca
    
    try {
      const { error } = await signUp(email, password, firstName, lastName, schoolId);
          ...
          <div className="text-center">
            ...
            <div className="mt-4 text-md text-gray-600">
              ...
              <div className="mt-8 border-t pt-4">
                <p>
                  Already verified? <Link href="/auth/login" className="font-medium text-blue-600 hover:text-blue-500">Sign in</Link>
                </p>
              </div>
            </div>
          </div>
