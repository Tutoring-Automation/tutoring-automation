          ...
          <div className="rounded-md  -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                required
                className="appearance-none  w-full h-15 px-3 py-2 mt-5 rounded-[10px] border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
