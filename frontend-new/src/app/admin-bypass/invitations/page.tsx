...
export default function AdminInvitationsPage() {
  ...
  const handleCreateInvitation = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create invitation directly in Supabase
      const invitationData = {
        email: formData.email,
        role: formData.role,
        school_id: formData.role === 'admin' ? formData.school_id : null,
        invited_by: 'dc774f03-f83e-4cbe-93dd-38b44ea3d0c0', // Our superadmin ID
      ...
      const registrationUrl = `${window.location.origin}/auth/admin/register?token=${invitationToken}`;
  ...
  const confirmCancelInvitation = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        setError(`Failed to cancel invitation: ${error.message}`);
        return;
      }
          ...
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
              <div className="mt-3">
                ...
                <h3 className="text-lg font-medium text-gray-900 text-center mb-4">Cancel Invitation</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-center space-x-3 pt-4">
                    ...
                    <button
                      ...
                      className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 disabled:bg-red-300 focus:outline-none focus:ring-2 focus:ring-red-500"
                    >
